...
--INSERER UN NOUVEAU CONTRAT DANS LA TABLE TB_CONTRAT 
SELECT * FROM "TB_CONTART" ORDER BY "ID_CONTART"

INSERT INTO "TB_CONTART"("ID_CONTRAT","DT_DEBUT","DT_FIN","CD_TYPE_CONTRAT","ID_STAGIAIRE","NB_SALAIR","DT_ARRET_CONTRAT","LB_MOTIF_ARRET")
VALUES
('CSTG041','2021-09-23','2021-12-31','','STG005','2021-12-23','absences repetées');